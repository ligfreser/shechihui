package com.luxplat.manage.admin.action;
 ...
 import com.luxplat.core.security.SecurityManager;
 ...
 import com.luxplat.foundation.domain.RoleGroup;
 import com.luxplat.foundation.domain.SysConfig;
 import com.luxplat.foundation.domain.User;
 import com.luxplat.foundation.domain.query.UserQueryObject;
 import com.luxplat.foundation.service.IOrderFormService;
 import com.luxplat.foundation.service.IResService;
 import com.luxplat.foundation.service.IRoleGroupService;
 ...
 import com.luxplat.manage.buyer.action.BaseBuyerAction;
 import com.luxplat.manage.seller.action.BaseSellerAction;
 import com.luxplat.view.web.action.CartViewAction;
   ...
   implements ServletContextAware
 {
   ...
   public ModelAndView admin_save(HttpServletRequest request, HttpServletResponse response, String id, String role_ids, String list_url, String add_url)
   {
     ...
     if (id.equals("")) {
       boolean rid = this.userService.save(user);
     }
     else {
     ...
     for (String id : ids) {
       if (!id.equals("")) {
         ...
         if (!user.getUsername().equals("admin")) {
           this.databaseTools.execute("delete from luxplat_syslog where user_id=" + 
             id);
           this.databaseTools.execute("delete from luxplat_user_role where user_id=" + 
             id);
   ...
   public String init_role()
   {
     ...
     if ((current_user != null) && 
       ...
       this.databaseTools.execute("delete from luxplat_role_res");
       this.databaseTools.execute("delete from luxplat_res");
       this.databaseTools.execute("delete from luxplat_user_role");
       this.databaseTools.execute("delete from luxplat_role");
       this.databaseTools.execute("delete from luxplat_rolegroup");
