package com.luxplat.manage.admin.action;
 ...
 import com.luxplat.core.annotation.Log;
 ...
 import com.luxplat.foundation.domain.LogType;
 ...
 public class BaseManageAction
 {
     ...
     throws IOException
   {
     ...
     {
       Cookie luxplat_user_session = new Cookie("luxplat_user_session", 
         user.getId().toString());
       luxplat_user_session.setDomain(CommUtil.generic_domain(request));
 
       response.addCookie(luxplat_user_session);
     }
   ...
   public void logout_success(HttpServletRequest request, HttpServletResponse response) throws IOException
   {
     ...
     if (this.configService.getSysConfig().isSecond_domain_open()) {
       ...
       for (Cookie cookie : cookies) {
         if (cookie.getName().equals("luxplat_user_session")) {
           cookie.setMaxAge(0);
           cookie.setValue("");
   ...
   public ModelAndView login_error(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     if ((luxplat_view_type != null) && (!luxplat_view_type.equals(""))) {
       if (luxplat_view_type.equals("weixin")) {
   ...
   public ModelAndView authority(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     if (domain_error) {
       mv = new JModelAndView("error.html", this.configService.getSysConfig(), 
         this.userConfigService.getUserConfig(), 1, request, 
         response);
       mv.addObject("op_title", "域名绑定错误，请与http://www.luxplat.com联系");
     }
     return mv;
   }
   ...
   public void user_msg_save(HttpServletResponse response, String msg) throws HttpException, IOException
   {
     ...
     PostMethod method = new PostMethod(
       "http://www.luxplat.com/user_msg.htm");
