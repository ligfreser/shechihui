package com.luxplat.manage.admin.action;
 ...
 import com.luxplat.foundation.domain.query.GoodsSpecificationQueryObject;
 import com.luxplat.foundation.service.IAccessoryService;
 import com.luxplat.foundation.service.IGoodsSpecPropertyService;
 import com.luxplat.foundation.service.IGoodsSpecificationService;
 ...
 public class GoodsSpecificationManageAction
 {
   ...
   public void goods_property_delete(HttpServletRequest request, HttpServletResponse response, String id) {
     boolean ret = true;
     if (!id.equals("")) {
       this.databaseTools.execute("delete from luxplat_goods_spec where spec_id=" + 
         id);
       this.databaseTools.execute("delete from luxplat_cart_gsp where gsp_id=" + 
         id);
