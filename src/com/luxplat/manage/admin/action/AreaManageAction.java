...
import com.luxplat.foundation.domain.Area;
 import com.luxplat.foundation.domain.query.AreaQueryObject;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class AreaManageAction
 {
   ...
   public ModelAndView area_import(HttpServletRequest request, HttpServletResponse response, String list_url) throws Exception {
     ...
     this.databaseTools.execute("update luxplat_store set area_id=null");
 
     this.databaseTools.execute("update luxplat_address set area_id=null");
 
     this.databaseTools.execute("update luxplat_area set parent_id=null");
 
     this.databaseTools.execute("delete from luxplat_area");
   ...
   public ModelAndView area_export(HttpServletRequest request, HttpServletResponse response) throws Exception
   {
     ...
     String path = request.getSession().getServletContext().getRealPath("/") +
       ...
       "base.sql";
     String tables = "luxplat_accessory,luxplat_adv_pos,luxplat_advert,luxplat_articleclass,luxplat_article,luxplat_document,luxplat_navigation,luxplat_template,luxplat_sysconfig";
