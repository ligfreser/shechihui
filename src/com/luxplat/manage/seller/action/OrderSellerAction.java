 ...
 import com.luxplat.foundation.domain.ExpressCompany;
 ...
 import com.luxplat.foundation.domain.GoodsReturnItem;
 ...
 import com.luxplat.foundation.domain.query.OrderFormQueryObject;
 import com.luxplat.foundation.domain.virtual.TransInfo;
 import com.luxplat.foundation.service.IEvaluateService;
 import com.luxplat.foundation.service.IExpressCompanyService;
 import com.luxplat.foundation.service.IGoodsCartService;
 import com.luxplat.foundation.service.IGoodsReturnItemService;
 import com.luxplat.foundation.service.IGoodsReturnLogService;
 import com.luxplat.foundation.service.IGoodsReturnService;
 import com.luxplat.foundation.service.IGoodsService;
 import com.luxplat.foundation.service.IGroupGoodsService;
 import com.luxplat.foundation.service.IIntegralLogService;
 ...
 public class OrderSellerAction
 {
   ...
   public String order_fee_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String goods_amount, String ship_price, String totalPrice)
     throws Exception
   {
     OrderForm obj = this.orderFormService
       .getObjById(CommUtil.null2Long(id));
   ...
   public ModelAndView order_shipping(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
     ...
     if (obj.getStore().getId()
       ...
       List goodsCarts = this.goodsCartService.query(
       ...
       for (int i=0 ; i<goodsCarts.size() ; i++) {
    		GoodsCart gc = (GoodsCart) goodsCarts.get(i) ;      
   ...
   public String order_shipping_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String shipCode, String state_info, String order_seller_intro, String ec_id)
     throws Exception
   {
     OrderForm obj = this.orderFormService
       .getObjById(CommUtil.null2Long(id));
