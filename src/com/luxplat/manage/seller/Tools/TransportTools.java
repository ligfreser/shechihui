 package com.luxplat.manage.seller.Tools;
 
 import com.luxplat.core.domain.virtual.CglibBean;
 ...
 public class TransportTools
 {
   ...
   {
     String ret = "";
     List list = (List)Json.fromJson(ArrayList.class, json);
   ...
   private float cal_order_trans(String trans_json, int trans_type, Object goods_weight, Object goods_volume, String city_name)
   {
     float fee = 0.0F;
     boolean cal_flag = false;
     List list = (List)Json.fromJson(ArrayList.class, trans_json);
     if ((list != null) && (list.size() > 0)) {
  	   for (int i=0 ; i<list.size() ; i++) {
 		  Map map = (Map)list.get(i) ;
         String[] city_list = CommUtil.null2String(map.get("city_name"))
   ...
   public static void main(String[] args) throws UnsupportedEncodingException
   {
     ...
     List list = (List)Json.fromJson(ArrayList.class, s);
	   for (int i=0 ; i<list.size() ; i++)  {
		  Map map = (Map)list.get(i) ;
       	  System.out.println("this is index_"+i +"=======");
       	  System.out.println(map.get("city_id"));
       	  System.out.println(map.get("city_name"));
       	  System.out.println(map.get("trans_fee"));
	   }
   }
 }
