 package com.luxplat.core.security.support;
   ...
   implements UserDetailsService, SecurityManager
 {
   ...
   public Map<String, String> loadUrlAuthorities()
   {
     ...
     Map params = new HashMap();
     params.put("type", "URL");
     List urlResources = this.resService.query(
       "select obj from Res obj where obj.type = :type", params, -1, 
       -1);
     int i = 0 ;
     Res tmp_res = null ;
     for (;i<urlResources.size();i++) {
       tmp_res = (Res)urlResources.get(i) ;
       urlAuthorities.put(tmp_res.getValue(), tmp_res.getRoleAuthorities());
     }
