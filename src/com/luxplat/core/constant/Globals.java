 package com.luxplat.core.constant;
 
 public class Globals
 {
   public static final String DEFAULT_SYSTEM_TITLE = "LuxPlat奢侈汇电子商务平台系统V1.0版";
   public static final boolean SSO_SIGN = true;
   public static final int DEFAULT_PLAT_VERSION = 20160123;
   public static final String DEFAULT_PLAT_OUT_VERSION = "V1.0";
   public static final String DEFAULT_WBESITE_NAME = "luxplat";
   ...
   public static final String DEFAULT_TABLE_SUFFIX = "luxplat_";
   public static final String THIRD_ACCOUNT_LOGIN = "luxplat_thid_login_";
