 package com.luxplat.app.login.action;
...
import com.luxplat.uc.api.UCTools;
import com.luxplat.manage.admin.tools.MsgTools;
import com.luxplat.view.web.tools.ImageViewTools;
...
/* 
     ...
     throws HttpException, IOException
   {
     ...
     if (reg) {
       ...
       return "redirect:luxplat_login.htm?username=" + 
   ...
   @RequestMapping({"/app/luxMyInfo.htm"})
   public ModelAndView myInfo(HttpServletRequest request, HttpServletResponse response)
   {
     ModelAndView mv = new JModelAndView("luxMyInfo.html", 
       this.configService.getSysConfig(), 
       this.userConfigService.getUserConfig(), 2, request, response);
     return mv;
   }/*
   @RequestMapping({"/app/forget.htm"})
   public ModelAndView forget(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     if (!config.isEmailEnable()) {
       ...
       mv.addObject("url", CommUtil.getURL(request) + "/app/luxMyInfo.htm");
     }
     return mv;
   }*/
 
   @RequestMapping({"/app/findPwd.htm"})
   public ModelAndView findPws(HttpServletRequest request, HttpServletResponse response, String userName,String userPhone)
   {
     ModelAndView mv = new JModelAndView("findPwd.html", 
       this.configService.getSysConfig(), 
       this.userConfigService.getUserConfig(), 2, request, response);
     HttpSession session = request.getSession(false);
