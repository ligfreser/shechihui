package com.luxplat.foundation.log;
 ...
 import com.luxplat.foundation.domain.LogFieldType;
 import com.luxplat.foundation.domain.LogType;
 import com.luxplat.foundation.domain.SysLog;
 ...
 import com.luxplat.foundation.service.ISysLogService;
 ...
 public class SystemLogAdvice
 {
   ...
   @AfterReturning("execution(* com.luxplat.manage..*.*(..))&& @annotation(annotation)&&args(request,..) ")
   ...
   @AfterThrowing(value="execution(* com.luxplat.manage..*.*(..))&&args(request,..) ", throwing="exception")
